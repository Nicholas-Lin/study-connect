...
from .views import messageGroup, GroupListView, GroupDetailView, GroupCreateView, GroupUpdateView, GroupDeleteView, group_remove_member, group_add_self
from . import views

urlpatterns = [
    path('messageGroup/<str:slug>/', messageGroup, name = 'message-group'),
